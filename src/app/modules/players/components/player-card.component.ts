    ...
    >
      <div class="p-6">
        ...
        <div class="flex flex-col items-center text-center">
          ...
          @if (player.active) {
          <span
            class="mt-3 inline-block px-3 py-1 rounded-full text-xs font-semibold bg-primary/20 text-primary border border-primary/30"
            >Active</span
          >
          } @else {
          <span
            class="mt-3 inline-block px-3 py-1 rounded-full text-xs font-semibold bg-muted text-muted-foreground border border-border"
            >Inactive</span
          >
          }
        </div>
